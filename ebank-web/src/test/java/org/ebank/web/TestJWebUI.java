...
public class TestJWebUI {
    ...
    public void withdrawCash() throws Exception {
       ...
       // Now submit the form by clicking the button and get back the second page.
        ...
        final HtmlSubmitInput withdrawButton = form.getInputByName("withdraw");
        final HtmlTextInput withdrawalField = form.getInputByName("withdrawalAmount");
